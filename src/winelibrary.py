options = {
    "W" : ["Are you choosing this for yourself or for someone else?", f"1 - wine for myself", "2 - wine for someone else"],
    ...
    "SR" : ["Tell me more. Is this for:-", "1 - A dinner party?", "2 - A gift?"],
...
purpose = {
    ...
    "D3" : "is dining out somewhere nice.",
